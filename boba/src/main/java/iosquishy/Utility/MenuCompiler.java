...
public class MenuCompiler {
    ...
    private static final short bobaOccupancy = bobaDimensions + bobaLeftMargin;
    ...
    public static BufferedImage compileMenu(Menu menu, Image[] bobas) {
        //Create ImgStacker
        ...
        for (byte bobaImgX = 0; bobaImgX < maxHorizontalBobas; bobaImgX++)  {
            for (byte bobaImgY = 1; bobaImgY <= maxVerticalBobas; bobaImgY++) {
                ...
                if (currentBoba < bobas.length) {
                    ...
                    int currentBobaX = (bobaImgX*horizontalMenuDiv) + bobaOccupancy;
